  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
       ...
       <input type="hidden" value="<?php echo $_POST['tienda']; ?>" id="perfilOculto2">
      </div>
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <!-- ENTRADA PARA SELECCIONAR TIENDA -->
              ...
              <div class="form-group">
                  ...
                  <div class="input-group">
                      ...
                      <select class="form-control input-lg" id="nuevaTienda" name="nuevaTienda" required>
                          ...
                          $tiendas = ControladorTiendas::ctrMostrarTienda($item2, $valor2);
              ...
              <div class="form-group">
                  ...
                  <div class="input-group">
                      ...
                      <select class="form-control input-lg"  name="editarTienda" required>
                          ...
                          <option id="editarTienda" readonly>Seleccionar Tienda</option>
                          <?php
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa fa-th"></i></span>
                  ...
                  <select class="form-control input-lg"  name="editarCategoria"  required>
                     ...
                     <option id="editarCategoria" selected>Seleccionar categoría</option>
                      <?php
