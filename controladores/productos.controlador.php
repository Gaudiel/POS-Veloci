...
class ControladorProductos{
	...
	static public function ctrMostrarProductos2($item, $valor, $orden){
		...
		return ModeloProductos::mdlMostrarProductos2($tabla, $item, $valor, $orden, $sucursal);
