...
class ControladorVentas{
	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			$tabla = "ventas";
			$pago = $_POST["listaMetodoPago"];
            $pago2 = $_POST["listaMetodoPago2"];
            $pago = $pago.', el resto: '.$pago2;
			...
			$datos = array("id_vendedor"=>$_POST["idVendedor"],
						   ...
						   "serie"=>$_POST["nuevoNumSerie"],
						   "impuesto"=>$_POST["nuevoPrecioImpuesto"],
						   "neto"=>$_POST["nuevoPrecioNeto"],
						   "total"=>$_POST["totalVenta"],
						   "metodo_pago"=>$pago,
						   "factura"=> $_POST["listaMetodoFactura"]);
	...
	public function ctrDescargarReporte(){
		...
		if(isset($_GET["reporte"])){
			...
			echo utf8_decode("<table border='0'>
					...
					<td style='font-weight:bold; border:1px solid #eee;'>DIRECCION CLIENTE</td>
					<td style='font-weight:bold; border:1px solid #eee;'>VENDEDOR</td>
					<td style='font-weight:bold; border:1px solid #eee;'>TIENDA</td>
					<td style='font-weight:bold; border:1px solid #eee;'>CANTIDAD</td>
					<td style='font-weight:bold; border:1px solid #eee;'>PRODUCTOS</td>
					<td style='font-weight:bold; border:1px solid #eee;'>NUM. SERIE</td>
			...
			foreach ($ventas as $row => $item){
			 ...
			 echo utf8_decode("<tr>
			 			...
			 			<td style='border:1px solid #eee;'>".$cliente["documento"]."</td>
			 			<td style='border:1px solid #eee;'>".$cliente["direccion"]."</td>
			 			<td style='border:1px solid #eee;'>".$vendedor["nombre"]."</td>
			 			<td style='border:1px solid #eee;'>".$item["tienda"]."</td>
	...
	static public function ctrDescargarXML(){
		...
		if(isset($_GET["xml"])){
			...
			$objetoXML->writeRaw('<ext:venta>');


			foreach ($listaProductos as $key => $value) {

				$objetoXML->text(
				"Nombre del producto: ".$value["descripcion"].", ".
				"Numero de Serie: ".$ventas["serie"].", ".
				"SKU del Pruducto: ".$value["codigo"].", ".
				"Cantidad comprada: ".$value["cantidad"].", ".
				"Total pagado: ".$value["total"].", ".
				"Metodo de pago: ".$ventas["metodo_pago"].", ".
